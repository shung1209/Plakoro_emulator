...
static func get_all(starter_pokemon_id: StringName = &"") -> Array[Dictionary]:
...
static func get_by_id(
	...
	for encounter: Dictionary in get_all(starter_pokemon_id):
...
static func is_unlocked(
	...
	var encounters: Array[Dictionary] = get_all(starter_pokemon_id)
